...
module.exports = (function () {
    ...
    ngmotion.startWatch = function (onSuccess, onFail, _workingSpeed, _runningSpeed, _drivingSpeed, _frequence) {
        if (onSuccess) {
        ...
        if (typeof _workingSpeed === "number") {
            workingSpeed = _workingSpeed;
        }
